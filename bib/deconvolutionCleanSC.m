function [Q, msg] = deconvolutionCleanSC(R, e, w, loopGain, maxIterations)
...
if cleanMapIterations == maxIterations
    msg=['Stopped after maximum iterations (' num2str(maxIterations) ')'];
else
    msg=['Converged after ' num2str(cleanMapIterations) ' iterations'];
end
disp(msg);
